        ...
        <div class="card-body">         
            <form action="<?php echo URL.'product/update';?>" method="POST">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="codigo" name="codigo" placeholder="Código" value="<?php echo $this->product[0]['codigo'];?>" readonly="readonly">
                </div>
                <div class="form-group">
                    <label for="nombre">Nombre</label>
                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" value="<?php echo $this->product[0]['nombre'];?>">
                </div>
                <div class="form-group">
                    ...
                    <?php foreach($this->categories as $categoria): ?>
                        <option <?php if($categoria['id_categoria'] === $this->product[0]['id_categoria']){ echo "selected"; }?> value="<?php echo $categoria['id_categoria']; ?>"><?php echo $categoria['nombre']; ?></option>
                    <?php endforeach; ?>                        
                    </select>
                </div>
                <div class="form-group">
                    <label for="nombre">Alerta Stock Bajo</label>
                    <input type="number" class="form-control" id="alerta_bajo" name="alerta_bajo"  value="<?php echo $this->product[0]['alerta_bajo'];?>">
                </div>
                <div class="form-group">
                    <label for="nombre">Alerta Stock Critico</label>
                    <input type="number" class="form-control" id="alerta_critico" name="alerta_critico"  value="<?php echo $this->product[0]['alerta_critico'];?>">
                </div>
